...
Only requiring some minor changes is quaz.cpp.
...
Changes to quaz.cpp
----------------------
quaz.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
