...
This mechanism has been integrated into Bitcore-Node-Quaz which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/quazpay/insight-api-quaz#web-socket-api](https://github.com/quazpay/insight-api-quaz#web-socket-api)
* API: [https://github.com/quazpay/insight-api-quaz#instantsend-transactions](https://github.com/quazpay/insight-api-quaz#instantsend-transactions)
...
By default, the Quaz Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Quaz Core daemon:
