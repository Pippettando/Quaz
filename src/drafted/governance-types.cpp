...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "QuazNetwork") type = QuazNetwork;
    if(strType == "QuazNetworkVariable") type = QuazNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == QuazNetwork) s = "QuazNetwork";
    if(type == QuazNetworkVariable) s = "QuazNetworkVariable";
