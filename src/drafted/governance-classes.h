 ...
 *
 *   // network
 *   CQuazNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.quaz.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CQuazNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: QuazNetwork
// //   -- signature requirements : Key1(User)
// class CQuazNetworkVariable : public CGovernanceObject
// {
// private:
