...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Quaz Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  quaz-cli [options] <command> [params]  " + _("Send command to Quaz Core") + "\n" +
                  "  quaz-cli [options] help                " + _("List commands") + "\n" +
                  "  quaz-cli [options] help <command>      " + _("Get help for a command") + "\n";
