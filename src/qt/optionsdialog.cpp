    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("QUAZ-light"), QVariant("light"));
    ui->theme->addItem(QString("QUAZ-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("QUAZ-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("QUAZ-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("QUAZ-traditional"), QVariant("trad"));
