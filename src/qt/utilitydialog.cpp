    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Quaz Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Quaz Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  quaz-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Quaz in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 QUAZ, 0.1 QUAZ, 1 QUAZ and 10 QUAZ -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://quazpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://quazpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Quaz Core is shutting down...") + "<br /><br />" +
