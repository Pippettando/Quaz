    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Quaz Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Quaz address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and quaz: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Quaz Core"), this);
    aboutAction->setStatusTip(tr("Show information about Quaz Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Quaz Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Quaz addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Quaz addresses"));
    ...
    openAction->setStatusTip(tr("Open a quaz: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Quaz Core help message to get a list with possible Quaz Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Quaz Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Quaz network", "", count));
    } else {
...
{
    QString strTitle = tr("Quaz Core"); // default title
