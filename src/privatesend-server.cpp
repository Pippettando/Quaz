...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Quaz related functionality
...
/*
    ...
    allow endless transaction that would bloat Quaz and make it unusable. To
